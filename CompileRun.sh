...
export MESOS_HOME_DIR="/home/ubuntu/git_mesos/mesos"
...
$COMPILER $HEADER_FILES -lmesos -std=c++11 -fPIC -shared FedCommunication.cpp -o libFedCommunicationModule.so 
